...
private:
    ...
    // int new_mux_idx;
    int evader_mux_idx; // Added by me ******************************
    ...
    // int new_button_idx;
    int evader_button_idx; //added by me**************
    ...
    // int new_key_char;
    std::string evader_key_char; // added by me
...
public:
    BehaviorController() {
        ...
        n.getParam("evader_mux_idx", evader_mux_idx); //Added by me*****
        ...
        n.getParam("evader_button_idx", evader_button_idx); //Added by me****
        ...
        n.getParam("evader_key_char", evader_key_char);// Added by me********
